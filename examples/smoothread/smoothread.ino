...
int measurements[100];          // variable for holding raw measurements
int smoothed;                   // variable for holding filtered measurement
int smoothedCV;                 // variable for holding CV of measurements
...
void loop()
{
  ...
  for(int i=0;i<NUMSAMPLES;i++){
    ...
    measurements[i]=(5*(int)v/1024); // convert to volts
